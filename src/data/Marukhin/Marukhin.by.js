exports.frontmatter = {
  ...
  lang: 'by',
  birthPlace: 'в. Фёдараўка, Разанская вобласць',
  timelineData: [
    {
      date: '1960',
      text:
                'Працаваў аператарам-пастаноўшчыкам кінастудыі «Беларусьфільм».',
    },
    {
      date: '1962',
      text:
                'Скончыў аператарскі факультэт Усесаюзнага дзяржаўнага інстытута кінематаграфіі ў Маскве (майстэрня Леаніда Касматава).',
    },
    {
      date: '1984',
      text:
                'Рэжысёр мастацкага кіно.',
    },
    {
      date: '2000 - 2001',
      text:
                'Старшыня праўлення Беларускага саюза кінематаграфістаў.',
    },
    {
      date: '1981',
      text:
                'Атрымаў узнагароду Ордэна Знака Пашаны.',
    },
    {
      date: '1997, 2000',
      text:
                'Прэмія Міністэрства культуры Рэспублікі Беларусь і Прызёр Парламенцкага сходу Саюза Беларусі і Расіі.',
    },
    {
      date: '2007',
      text:
                'Ганаровы грамадзянін Мічурынску.',
    },
  ],
  work: [
    {
